...
<div class="content">
  <div class="row">
    ...
    <div class="col m5 rates-card rates-text">
      ...
      <div class="col s8 m8 left-align" style="font-style:italic;font-size:12px">
        * Exceeding Hours
      </div>
      <div class="col s4 m4 right-align" style="font-size:12px">
        ₱ 75/hr
      </div>
    </div>
  </div>
  <div class="row flex-s">
    <div class="col m5 rates-card rates-text box-a service-content">
      ...
      <br><br>
      <div class="col m8 service-content">
        Whole Day Pass
      </div>
