...
<div class="content">
  <div class="row">
    ...
    <div class="col l5 rates-card rates-text">
  ...
  <div class="row flex-s">
    <div class="col l5 m12 rates-card rates-text box-a">
      ...
      <div class="col l4 m4 right-align">
        ₱ 300
      </div>
      <br><br>
      <div class="col l8 m8">
  ...
  <div class="row">
    <div class="col l7 m12 rates-card">
      <img src="{{ asset('img/sample.png') }}" width="100%" height="100%">
    </div>
    <div class="col  l5  m12 rates-card rates-text ">
      <div class="title">Film Room</div>
      <div class="subtitle">Good for 20 pax</div>
      <br><br>
      <div class="col m8 l8 left-align">
        1 hour (₱ 60/pax)
      </div>
      <div class="col m4 l4 right-align">
        ₱ 1,200
      </div>
      <br><br>
      <div class="col m8 l8 left-align">
  ...
  <div class="row flex-s">
    <div class="col l5 rates-card rates-text box-a">
