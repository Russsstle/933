  ...
  <ol>
    ...
    <li>
      ...
      <p>
        ...
        <ul class="dashed">
          <li>Each member is entitled to only one (1) sample order every day.</li>
          <li>Each member is entitled to one (1) bundle of sample for each product.</li>
          <li>Your account must have sufficient points before you can checkout the sample products.</li>
          <li>Kindly clear all pending payments before another checkout.</li>
        </ul>
      </p>
    </li>
    <li>
    ...
    <li>
      ...
      <p>
        Members who ship their orders within Singapore should expect to receive their orders within five (5) to ten (10) working days upon payment verification depending on the volume of orders received.<br><br>
    ...
    <li>
      ...
      <p>
        The flat-rate handling fee is $5.99 and it is only applicable to normal samples. For free samples, they are fully paid for and there are no additional charges to deliver the free samples.
      </p>
    </li>
  </ol>
</div>
