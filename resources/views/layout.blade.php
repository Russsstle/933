...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/app-responsive.css') }}?v={{ filemtime(public_path('css/app-responsive.css')) }}" media="screen and (max-width:767px)">
...
<body>
  ...
  @yield('body')
  @include('footer')
  <script src="{{ asset('manifest.js') }}?v={{ filemtime(public_path('manifest.js')) }}"></script>
