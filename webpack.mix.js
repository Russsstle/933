...
mix.combine(
  ['resources/js/packages/jquery.min.js', 'resources/js/packages/materialize.min.js'], 'public/js/website/packages.js')
mix.babel(['resources/js/website/script.js'], 'public/js/website/app.js')
/* CPANEL */
mix.combine(
  ['resources/css/packages/bootstrap.min.css', 'resources/css/packages/font-awesome.min.css'], 'public/css/cpanel/packages.css')
...
mix.combine(
  ['resources/js/packages/jquery.min.js', 'resources/js/packages/bootstrap.min.js', 'resources/js/packages/jquery.dataTables.min.js', 'resources/js/packages/dataTables.bootstrap4.min.js'], 'public/js/cpanel/packages.js')
